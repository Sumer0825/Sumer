...
const CACHE = 'p612-v64';
const CORE = ['./', './index.html', './time.html', './weight.html', './budget.html', './storage.html',
  './assets/bg-storage.png', './assets/bg-budget.png', './assets/bg-weight.png', './assets/bg-time.png'];
